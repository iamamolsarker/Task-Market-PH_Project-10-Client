    ...
    return (
        <div className='min-h-[75vh] flex flex-col items-center justify-center' style={{backgroundImage: `url(${BannerBg})`}}>
            <div className='max-w-10/12 mx-auto text-center space-y-5'>
                ...
                <p className='text-lg'>Whether you're a developer, designer, writer, or marketer, find high-paying projects that match your skills and schedule. Start earning today.</p>
